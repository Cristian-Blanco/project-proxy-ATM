        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (ClientProxy.isState()) {
                ...
                out.println("   <main>\n"
                        ...
                        + "                      <input type=\"text\" class=\"form-control\" id=\"money\" name=\"money\" aria-describedby=\"emailHelp\" required>\n"
                        + "                      <small id=\"emailHelp\" class=\"form-text text-muted\">Saldo Actual: "+ String.valueOf(Redirect.proxie.getDinero(page.getCuenta())) +"</small>\n"
                        + "                    </div>                 \n"
                        + "            </div>\n"
                        ...
                        + "      \n"
                        + "      <section id=\"blog\">\n"
                        + "<h3>" + String.valueOf(Redirect.proxie.getDinero(page.getCuenta())) + "</h3>"
                        + "      </section>\n"
                        + "      \n"
                        + "      <section id=\"info\">\n"
                        ...
                        + "          <div class=\"contenedor\">\n"
                        + "              <div class=\"info-pet\">\n"
                        + "                  <img src=\"https://images.unsplash.com/photo-1586034679970-cb7b5fc4928a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80\" alt=\"\">\n"
                        + "                  <h4>" + String.valueOf(Redirect.proxie.getNombre(page.getCuenta())) + "</h4>\n"
                        + "              </div>\n"
                        + "          </div>\n"
                        + "      </section>\n"
                        + "  </main>\n"
            ...
            System.out.println(ClientProxy.isState());
            ClientProxy.setState(false);
